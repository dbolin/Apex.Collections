...
namespace Apex.Collections
{
    ...
    {
        public static readonly NonRandomOrdinalIgnoreCaseComparer NonRandomOrdinalIgnoreCase = new NonRandomOrdinalIgnoreCaseComparer();
        public static readonly NonRandomOrdinalComparer NonRandomOrdinal = new NonRandomOrdinalComparer();
    }

    public sealed class NonRandomOrdinalIgnoreCaseComparer : IEqualityComparer<string>, IComparer<string>
    {
        internal NonRandomOrdinalIgnoreCaseComparer() { }
        ...
        {
            return System.StringComparer.OrdinalIgnoreCase.Equals(x, y);
        }

        public int GetHashCode(string obj)
        {
            return NonRandomHashCode.OrdinalIgnoreCase(obj);
        }
    }

    public sealed class NonRandomOrdinalComparer : IEqualityComparer<string>, IComparer<string>
    {
        internal NonRandomOrdinalComparer() { }
        ...
        public bool Equals(string x, string y)
        {
            return System.StringComparer.Ordinal.Equals(x, y);
        }

        public int GetHashCode(string obj)
        {
            return NonRandomHashCode.Ordinal(obj);
        }
    }
}
